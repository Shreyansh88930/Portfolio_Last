    ...
    <div id="contact">
      <div  className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12'>
        ...
        className='text-slate-400 mt-4'>
            Lets make something new,different and more meaningful things are more visual or conceptual
        </motion.p>
      </div>
      <div className='max w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        className='space-y-4 text-white'>
            ...
            whileTap={{ scale:0.95 }}
            type='submit' className='bg-purple-500 text-white px-6 py-3 rounded-md hover:bg-purple-600 transition duration-200'>
            Submit Message
            </motion.button>
        </motion.form>
      </div>
